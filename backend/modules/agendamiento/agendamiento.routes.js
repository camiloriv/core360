...
router.post('/marcar-reagendada', verificarToken, agendamientoController.marcarReagendada);
...
router.post('/teams-eventos/:id/marcar-excluida', verificarToken, agendamientoController.marcarExcluida);
router.post('/teams-eventos/:id/marcar-proforma', verificarToken, agendamientoController.marcarProforma);
